    ...
    <nav style={{ background: C.bg, borderBottom: `1px solid ${C.bdr}`, fontFamily: "system-ui, sans-serif" }}>
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "0 1rem" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "0.5rem" }}>
          <Link href={`/r/${slug}`} style={{ display: "flex", alignItems: "center", textDecoration: "none", padding: "8px 14px", borderRadius: "10px", background: "#0f1729", flexShrink: 0, margin: "8px 0" }}>
            <img src="/logo.png" alt="Reserva360" style={{ height: 56, objectFit: "contain" }} />
          </Link>
